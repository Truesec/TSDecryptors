...
namespace CristiPotlog.Controls
{
	...
	public class Wizard : System.Windows.Forms.UserControl
	{
		...
		#region Fields
		private IWizardPage selectedPage = null;
		...
		public Wizard()
		{
			...
			this.pages = new List<IWizardPage>();
		}
		...
		{
			get => this.pages.IndexOf(this.selectedPage);
			set
			{
		...
		private void ActivatePage(IWizardPage page)
		{
			// validate given page
			...
			{
				this.selectedPage.Deactivated();
				((WizardPage)this.selectedPage).Visible = false;
			}
			...
			if (this.selectedPage != null)
			{
                ...
                ((WizardPage)this.selectedPage).Parent = this;
				if (this.Contains(((WizardPage)this.selectedPage)) == false)
				{
					this.Container.Add(((WizardPage)this.selectedPage));
				}
                ...
                this.selectedPage.Activated();

                //Make it fill the space
                ((WizardPage)this.selectedPage).SetBounds(0, 0, this.Width, this.Height - FOOTER_AREA_HEIGHT);
                ((WizardPage)this.selectedPage).Visible = true;
                ((WizardPage)this.selectedPage).BringToFront();
				this.FocusFirstTabIndex(((WizardPage)this.selectedPage));
			}
			...
			if (this.selectedPage != null)
			{
                ((WizardPage)this.selectedPage).Invalidate();
			}
			else
			{
				this.Invalidate();
		...
		protected override void OnControlAdded(ControlEventArgs e)
		{
				...
				e.Control != this.buttonBack)
			{
				...
				if (this.selectedPage != null)
				{
                    ((WizardPage)this.selectedPage).Controls.Add(e.Control);
				}
			}
			else
			{
